      ...
      <main className='flex flex-col justify-center items-center flex-1 px-4'>
        <div className='w-full max-w-md flex flex-col gap-6 border border-border bg-surface rounded-xl px-12 py-10'>
            ...
            <label className='flex flex-col gap-1.5'>
              <div className='flex justify-between items-center'>
                ...
                <Link
                  ...
                  className='text-sm text-muted hover:text-foreground transition-colors duration-150 pl-2 rounded-xs'
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <p className='text-center text-muted'>
            ...
            <Link
              href='/register'
              className='text-outline font-medium hover:text-outline/80 transition-colors duration-150 rounded-xs'
            >
              Sign up
            </Link>
          </p>
